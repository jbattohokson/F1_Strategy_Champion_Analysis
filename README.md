...
A multi-season Formula 1 analysis covering the **2022–2024 ground effect era**, examining how championship-contending drivers differ from the mid-field in tire compound selection, pit stop timing, and lap-time degradation. The project is benchmarked from **Ferrari's perspective**: where does raw pace go unrealized, and what strategic adjustments could recover positions?
...
- **Ferrari benchmark** — compare Ferrari's metrics against podium finishers and full field
